...
import { Mailbox } from 'src/app/features/apps/email/email';
import { mailboxList } from 'src/app/features/apps/email/email-data';
import { User } from 'src/app/features/apps/email/user-data';

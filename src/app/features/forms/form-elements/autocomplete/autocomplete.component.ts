...
export class AppAutocompleteComponent implements OnInit {
  ...
  // 2 [Option Group with Autocomplete]
  codeForOptionGroup = OPTION_GROUP_HTML_SNIPPET;
  codeForOptionGroupTs = OPTION_GROUP_TS_SNIPPET;

  // 3 [Filter with Autocomplete]
  codeForFilter = FILTER_HTML_SNIPPET;
  codeForFilterTs = FILTER_TS_SNIPPET;

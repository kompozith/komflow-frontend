...
export class AppBasicTableComponent implements OnInit {
  ...
  // 2 [Best Product with Table]
  codeForBestProduct = BEST_PRODUCT_TABLE_HTML_SNIPPET;
  codeForBestProductTs = BEST_PRODUCT_TABLE_TS_SNIPPET;

  // 3 [Payment Gateways with Table]
  codeForPaymentGateways = PAYMENT_GATEWAYS_TABLE_HTML_SNIPPET;
  codeForPaymentGatewaysTs = PAYMENT_GATEWAYS_TABLE_TS_SNIPPET;

  // 4 [Employee The Year with Table]
  codeForEmployeeTheYear = EMPLOYEE_THE_YEAR_TABLE_HTML_SNIPPET;
